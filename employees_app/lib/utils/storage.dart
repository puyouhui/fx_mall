...
class Storage {
  static const String _keyToken = 'employee_token';
  static const String _keyEmployeeInfo = 'employee_info';
  ...
  // 保存员工信息
  static Future<void> saveEmployeeInfo(Map<String, dynamic> employeeInfo) async {
    final prefs = await SharedPreferences.getInstance();
